...
Чтобы подключить растровый слой, откройте карточку ранее созданного <a href="#Создание-группы-слое/вкартографического-слоя">картографического слоя</a> в режиме редактирования и заполните следующие поля:
