...
<a name="Управление-геокодированными-объектами-Универсальная-геокатегория">
...
![](https://github.com/citoruspm/GeoData/blob/master/Image%20173.png?raw=true "Рисунок 1 – Универсальная геокатегория")

Рисунок 1 – Универсальная геокатегория
<a name="Работа-с-картой-в-универсальной-геокатегории">
...
<a name="Добавление-геоданных-объекта">
...
<a name="Редактирование-геоданных-объекта">
...
<a name="Экспортимпорт-геоданных-объекта">
...
<a name="Работа-с-картографическими-слоями">
...
<a name="Порядок-действий-при-создании-группыслоя">
...
<a name="Создание-группы-слоевкартографического-слоя">
...
![](https://github.com/citoruspm/GeoData/blob/master/ris9.png?raw=true "Рисунок 9 – Создание картографического слоя")
...
<a name="Создание-постоянного-векторного-слоя">
...
![](https://github.com/citoruspm/GeoData/blob/master/ris16_1.png?raw=true)
...
![](https://github.com/citoruspm/GeoData/blob/master/ris16_2.png?raw=true)
...
![](https://github.com/citoruspm/GeoData/blob/master/ris16_3.png?raw=true)
...
<a name="Создание-временного-векторного-слоя">
### Создание временного векторного слоя
<a name="Подключение-удаленного-растрового-слоя">
...
![](https://github.com/citoruspm/GeoData/blob/master/ris17.png?raw=true "Рисунок 17 – Настройки растрового слоя")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris18.png?raw=true "Рисунок 18 – Контекстное меню")

Рисунок 18 – Контекстное меню

-   В дереве объектов выделите требуемую группу/слой нажатием левой клавиши мыши. В новой вкладке откроется карточка группы/слоя (рис. 19). Чтобы активировать ее поля, на панели инструментов нажмите на кнопку **Редактировать** ![](https://github.com/citoruspm/GeoData/blob/master/13.png?raw=true).

![](https://github.com/citoruspm/GeoData/blob/master/ris19.png?raw=true "Рисунок 19 – Карточка картографического слоя")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris20.png?raw=true "Рисунок 20 – Общие поля")

Рисунок 20 – Общие поля
<a name="Настройки-векторных-слоев">
#### Настройки векторных слоев
<a name="Настройки-кластеризации">
...
<a name="Настройка-отображения-маркеров-слоя">
...
<a name="Свойства-всплывающего-окна">
...
<a name="Настройки-растровых-слоев">
...
![](https://github.com/citoruspm/GeoData/blob/master/ris22.png?raw=true "Рисунок 22 – Настройки растровых слоев")
...
<a name="Управление-геоданными-на-карте">
Управление геоданными на карте
---------------

Чтобы открыть карту, в главном меню системы нажмите на кнопку **Карта** (рис. 23).

![](https://github.com/citoruspm/GeoData/blob/master/ris23.png?raw=true "Рисунок 23 – Кнопка **Карта**")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris24.png?raw=true "Рисунок 24 – Инструменты работы с картой")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris25.png?raw=true "Рисунок 25 – Меню управления геоподосновами")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris26.png?raw=true "Рисунок 26 – Кнопка перехода в меню управления слоями")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris27.png?raw=true "Рисунок 27 – Меню управления слоями")
<a name="Меню-инструментов"></a>
Рисунок 27 – Меню управления слоями

-   ![](https://github.com/citoruspm/GeoData/blob/master/14.png?raw=true) – координаты точки, на которую указывает курсор на карте (рис. 28).
-   **Текущий масштаб** –
...
![](https://github.com/citoruspm/GeoData/blob/master/ris28.png?raw=true "Рисунок 28 – Меню управления слоями")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris29.png?raw=true "Рисунок 29 – Таймлайн")
...
2.  Откройте календарь нажатием на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/15.png?raw=true) (рис. 30). Щелчком мыши выберите начальную дату требуемого периода. Затем, удерживая на клавиатуре клавишу **Shift**, щелчком мыши отметьте конечную дату требуемого периода.
...
![](https://github.com/citoruspm/GeoData/blob/master/ris30.png?raw=true)

Рисунок 30 – Календарь

### Меню инструментов

Меню инструментов разворачивается при нажатии на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/4.png?raw=true) (рис. 31).
...
![](https://github.com/citoruspm/GeoData/blob/master/ris31.png?raw=true)
...
![](https://github.com/citoruspm/GeoData/blob/master/ris32.png?raw=true)
...
![](https://github.com/citoruspm/GeoData/blob/master/ris33.png?raw=true)

Рисунок 33 – Полигон

Если нарисованную фигуру полигона требуется редактировать, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/6.png?raw=true). На фигуре отобразятся крайние и промежуточные точки, которые можно перемещать с помощью мыши (рис. 34). Установите точки в требуемое положение и нажмите на кнопку **Сохранить**, которая отображается под кнопкой ![](https://github.com/citoruspm/GeoData/blob/master/6.png?raw=true). Затем перейдите в карточку полигона, как это описано выше.

![](https://github.com/citoruspm/GeoData/blob/master/ris34.png?raw=true)

Рисунок 34 – Режим редактирования полигона

Чтобы нарисовать линию, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/18.png?raw=true). Щелчками мыши по карте установите крайние точки линии. Затем нажмите повторно на конечную точку фигуры. Над крайней точкой отобразится маркер со всплывающей подсказкой, в которой содержится ссылка для перехода в карточку нарисованного объекта (рис. 35).

![](https://github.com/citoruspm/GeoData/blob/master/ris35.png?raw=true)
...
Если фигуру объекта требуется редактировать, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/6.png?raw=true). На линии отобразятся крайние и промежуточные точки, которые можно перемещать с помощью мыши (рис. 36). Установите точки в требуемое положение и нажмите на кнопку **Сохранить**, которая отображается под кнопкой ![](https://github.com/citoruspm/GeoData/blob/master/6.png?raw=true). Затем перейдите в карточку нарисованного объекта, как это описано выше.

![](https://github.com/citoruspm/GeoData/blob/master/ris36.png?raw=true)
...
Чтобы распечатать текущий фрагмент карты, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/19.png?raw=true), которая расположена под меню инструментов (рис. 36).
...
![](https://github.com/citoruspm/GeoData/blob/master/ris37.png?raw=true)
